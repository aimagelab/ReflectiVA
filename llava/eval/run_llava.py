...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="aimagelab/LLaVA_MORE-llama_3_1-8B-finetuning")
    parser.add_argument("--model_base", type=str, default=None)
    parser.add_argument("--image_file", type=str, default='https://farm2.staticflickr.com/1168/4723652147_ae14813f08_z.jpg')
